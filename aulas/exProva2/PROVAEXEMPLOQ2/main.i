# 1 "D:\\Users\\Marco\\Documents\\2022_2\\codeblocks\\PROVAEXEMPLOQ2\\main.c"
# 1 "D:\\Users\\Marco\\Documents\\2022_2\\codeblocks\\PROVAEXEMPLOQ2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:\\Users\\Marco\\Documents\\2022_2\\codeblocks\\PROVAEXEMPLOQ2\\main.c"
...
# 2 "D:\\Users\\Marco\\Documents\\2022_2\\codeblocks\\PROVAEXEMPLOQ2\\main.c" 2
...
#pragma pack(pop)
# 3 "D:\\Users\\Marco\\Documents\\2022_2\\codeblocks\\PROVAEXEMPLOQ2\\main.c" 2


# 4 "D:\\Users\\Marco\\Documents\\2022_2\\codeblocks\\PROVAEXEMPLOQ2\\main.c"
void Cria_Matriz(int (*)[10],int,int );
void Imprime_Matriz(int [][10],int,int );
void Aumenta_Matriz(int [][10],int*,int,int );
int main()
{
    int matriz[10][10],m,n,coluna[10];
    setlocale(
# 10 "D:\\Users\\Marco\\Documents\\2022_2\\codeblocks\\PROVAEXEMPLOQ2\\main.c" 3
             2
# 10 "D:\\Users\\Marco\\Documents\\2022_2\\codeblocks\\PROVAEXEMPLOQ2\\main.c"
                     ,"");
...
void Cria_Matriz(int (*pmatriz)[10],int m,int n)
{
    int i,j;
    for (i=0; i<m; i++)
        for (j=0; j<n; j++)
...
void Imprime_Matriz(int pmatriz[][10],int m,int n)
{
    for (int i=0; i<m; i++)
    {
         printf("|");
...
void Aumenta_Matriz(int pmatriz[][10],int*p,int m,int n)
{
    for (int i=0; i<m; i++)
    {
         pmatriz[i][n]=*(p+i);
